...
<body>
    <div class="logo">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="cart/16.jpg" alt="Image" class="img-fluid">
          </div>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multi/form-data">
            ...
            <div class="form-group">
                <label>AMOUNT</label>
                <input type="text" name="amount" class="form-control" value="800" placeholder="800" disabled>
            </div> 
            <div class="form-group">
                <label>IMG-ID</label>
                <input type="text" name="img_id" class="form-control" value="Peace OF Mind" placeholder="Peace OF Mind" disabled>
            </div> 
            <div class="form-group">
