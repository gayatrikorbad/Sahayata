                ...
                if( empty($nameErr) && empty($emailErr) && empty($stateErr) && empty($cityErr) && empty($contactErr) && empty($ptypeErr) && empty($usernameErr)){
                    ...
                    if($stmt = mysqli_prepare($link, $sql)){
                        if(mysqli_stmt_execute($stmt)){    
                            ...
                            echo '<script>alert("THANK YOU!!DETAILS WILL BE EMAILED YOU SOON")</script>';
                        } else{
...
<body>
    <div class="logo">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="cart/1.jpg" alt="Image" class="img-fluid">
          </div>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multi/form-data">
            ...
            <div class="form-group">
                <label>AMOUNT</label>
                <input type="text" name="amount" class="form-control" value="500" placeholder="500" disabled>
            </div> 
            <div class="form-group">
                <label>IMG-ID</label>
                <input type="text" name="img_id" class="form-control" value="Mandala Art" placeholder="Mandala Art" disabled>
            </div> 
            <div class="form-group">
